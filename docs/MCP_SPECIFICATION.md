...
1. **FastMCP Server**: Handles MCP protocol and tool registration
2. **ApiKeyVerifier**: Validates API keys and manages user context
3. **Service Layer**: Business logic for artifact operations
4. **Context Management**: Thread-safe user identification
